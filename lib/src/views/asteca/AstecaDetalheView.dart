...
/**
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(vertical: 4.0),
                          child: TextComponent(
                              'Nome do fornecedor: ${pedidoConfirmacao.asteca!.compEstProd!.produto!.fornecedores!.first.cliente!.nome}'),
                        ),
                      ],
                    ),
                    padding: EdgeInsets.fromLTRB(10.0, 5.0, 10.0, 5.0))
  ...
  criarPedidoEntrada() async {
    ...
    try {
      ...
      await astecaController.repository.pendencia.criar(astecaController.asteca, pendencia);
  ...
  buscarProdutoPecas() async {
    ...
    produtoController.produto.produtoPecas = await produtoController.produtoRepository
        .buscarProdutoPecas(astecaController.asteca.compEstProd!.produto!.idProduto!.toString());
    setState(() {
                                        ...
                                        child: Container(
                                          ...
                                          child: Padding(
                                              ...
                                              child: astecaController.asteca.astecaTipoPendencias!.isNotEmpty
                                                  ? TextComponent(
                                                      astecaController.asteca.astecaTipoPendencias!.last.idTipoPendencia
                                                              .toString() +
                                                          ' - ' +
          ...
          astecaController.carregado
              ? Container(
                  ...
                  child: ListView.builder(
                    itemCount: astecaController.asteca.astecaTipoPendencias!.length,
                    itemBuilder: (context, index) {
                      return Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Row(
            ...
            children: [
              Expanded(
                child: InputComponent(
                  ...
                  key: UniqueKey(),
                  label: 'ID',
                  initialValue: astecaController.asteca.compEstProd!.produto!.idProduto == null
                      ? ''
                      : astecaController.asteca.compEstProd!.produto!.idProduto.toString(),
                ),
              ),
              SizedBox(
                width: 12,
              ...
              Expanded(
                ...
                child: InputComponent(
                  ...
                  key: UniqueKey(),
                  label: 'Nome',
                  initialValue: astecaController.camelCaseFirst(astecaController.asteca.compEstProd!.produto!.resumida == null
                      ? ''
                      : astecaController.asteca.compEstProd!.produto!.resumida),
                ),
              ),
              SizedBox(
                width: 12,
            ...
            children: [
              Expanded(
                child: InputComponent(
                  ...
                  key: UniqueKey(),
                  label: 'ID',
                  initialValue: astecaController.asteca.compEstProd!.produto!.fornecedores!.first.idFornecedor == null
                      ? ''
                      : astecaController.asteca.compEstProd!.produto!.fornecedores!.first.idFornecedor.toString(),
                ),
              ),
              SizedBox(
                width: 12,
              ...
              Expanded(
                ...
                child: InputComponent(
                  ...
                  label: 'Nome',
                  initialValue: astecaController.camelCaseAll(
                      astecaController.asteca.compEstProd!.produto!.fornecedores!.first.cliente?.nome == null
                          ? ''
                          : astecaController.asteca.compEstProd!.produto!.fornecedores!.first.cliente?.nome),
                ),
              ),
              SizedBox(
                width: 12,
