    ...
    try {
      if (await Notificacao.alerta(
        ...
        await produtoRepository.inserirProdutoPecas(
            idProduto, gerarListaProdutoPeca());
        buscarProdutoPecas();
        Get.back();
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: InputComponent(
                                  initialValue: itensPeca[index]
                                      ...
                                      .toString(),
                                  onSaved: (value) {
                                    itensPeca[index].produtoPeca.peca!.volumes =
                                        value;
                                  },
                                ),
                              ),
                              ...
                              Expanded(
                                  child: InputComponent(
                                initialValue:
                                    itensPeca[index].produtoPeca.peca!.cor,
                                onSaved: (value) {
                                  itensPeca[index].produtoPeca.peca!.cor =
                                      value; //Cor
                                },
