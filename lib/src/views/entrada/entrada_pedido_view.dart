...
class _EntradaPedidoViewState extends State<EntradaPedidoView> {
  ...
  adicionarPedido(String numPedido) async {
    ...
    try {
      pedidoEntradaBusca = await pedidoEntradaController.repository.buscarPedidoEntrada(int.parse(numPedido));
      ...
      if (movimentoEntradaController.id_fornecedor == null) {
        movimentoEntradaController.id_fornecedor =
            pedidoEntradaBusca.asteca?.compEstProd!.first.produto!.fornecedores!.first.idFornecedor;
        setState(() {
          _controllerFornecedor.text =
              pedidoEntradaBusca.asteca?.compEstProd!.first.produto!.fornecedores!.first.cliente?.nome ?? '';
        });
      }
