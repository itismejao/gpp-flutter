...
class PecaEstoqueController {
  ...
  late final PecaEstoqueRepository pecasEstoqueRepository = PecaEstoqueRepository();
  ...
  Future<bool> consultarEstoque(
    ...
    List lista = await pecasEstoqueRepository.consultarEstoque(paginaAtual, filial, id_peca, id_produto, id_fornecedor, endereco,
        disponivel, reservado, transferencia, desc_corredor, desc_estante, desc_prateleira, desc_box);
