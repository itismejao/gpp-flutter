...
class PecaEstoqueController{
  ...
  Future<bool> consultarEstoque(int paginaAtual, String filial, String id_peca, String id_produto, String id_fornecedor, bool? endereco, bool disponivel, bool reservado, bool transferencia, String desc_corredor, String desc_estante, String desc_prateleira, String desc_box) async {
    List lista = await pecasEstoqueRepository.consultarEstoque(paginaAtual, filial, id_peca, id_produto, id_fornecedor, endereco, disponivel, reservado, transferencia, desc_corredor, desc_estante, desc_prateleira, desc_box);
