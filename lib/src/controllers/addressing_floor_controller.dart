...
class AddressingFloorController {
  PisoEnderecamentoRepository repository = PisoEnderecamentoRepository(api: gppApi);
  bool isLoaded = false;

  late PisoEnderecamentoModel pisoEnderecamentoReplacement = PisoEnderecamentoModel();
